...
| 位置 | 内容类型 | 说明 |
|------|----------|------|
| `01-捕获层/每日笔记/` | 散碎笔记 | 不满足原子化要求，需要拆分或整理 |
| `04-创造层/归档/` | 项目/课程型 | 有组织结构的笔记集，需决定处理方式 |
...
> **L层**（Learning/知识层）= 02-培养层，知识型内容，转为永久笔记
> **W层**（Work/创造层）= 04-创造层，项目型内容，转为项目
