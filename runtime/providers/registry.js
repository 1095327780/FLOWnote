...
const PROVIDERS = {
  "deepseek": {
    ...
    models: [
      ...
      { id: "deepseek-chat",     label: "DeepSeek Chat (legacy)",     tier: "mid",  deprecated: true, deprecationDate: "2026-07-24" },
      { id: "deepseek-reasoner", label: "DeepSeek Reasoner (legacy)", tier: "mid",  deprecated: true, deprecationDate: "2026-07-24" },
    ],
  ...
  "anthropic-official": {
    ...
    models: [
      { id: "claude-opus-4-7",     label: "Claude Opus 4.7",     contextWindow: 200_000, tier: "high" },
      { id: "claude-sonnet-4-6",   label: "Claude Sonnet 4.6",   contextWindow: 1_000_000, tier: "high", isDefault: true },
      { id: "claude-haiku-4-5",    label: "Claude Haiku 4.5",    contextWindow: 200_000, tier: "fast" },
    ],
  ...
  "zhipu-glm": {
    ...
    models: [
      { id: "glm-5",          label: "GLM-5",          contextWindow: 200_000, tier: "high" },
      { id: "glm-4.7",        label: "GLM-4.7",        contextWindow: 200_000, tier: "mid" },
      { id: "glm-4.7-flash",  label: "GLM-4.7 Flash",  contextWindow: 200_000, tier: "fast", isDefault: true },
    ],
  ...
  "minimax": {
    ...
    models: [
      { id: "MiniMax-M2.7-highspeed", label: "MiniMax M2.7 高速", tier: "fast", isDefault: true },
      { id: "MiniMax-M2.7",           label: "MiniMax M2.7",      tier: "high" },
      { id: "MiniMax-M2.5-highspeed", label: "MiniMax M2.5 高速", tier: "fast" },
      { id: "MiniMax-M2.5",           label: "MiniMax M2.5",      tier: "mid" },
    ],
  ...
  "moonshot-kimi": {
    ...
    auth: { headerName: "Authorization", scheme: "bearer" },
    models: [
      { id: "kimi-k2.5", label: "Kimi K2.5", contextWindow: 200_000, tier: "high", isDefault: true },
    ],
  ...
  "qwen": {
    ...
    auth: { headerName: "Authorization", scheme: "bearer" },
    models: [
      { id: "qwen-coder-plus", label: "Qwen Coder Plus", tier: "high", isDefault: true },
      { id: "qwen-max",        label: "Qwen Max",        tier: "high" },
      { id: "qwen-flash",      label: "Qwen Flash",      tier: "fast" },
    ],
  ...
  "doubao": {
    ...
    models: [
      { id: "doubao-pro-32k", label: "Doubao Pro 32K (示例 endpoint-id)", tier: "high" },
    ],
  ...
  "openai-official": {
    ...
    auth: { headerName: "Authorization", scheme: "bearer" },
    models: [
      { id: "gpt-5.4",        label: "GPT-5.4",        tier: "high", isDefault: true },
      { id: "gpt-5.4-mini",   label: "GPT-5.4 Mini",   tier: "fast" },
      { id: "gpt-5.4-turbo",  label: "GPT-5.4 Turbo",  tier: "mid" },
    ],
